...
/datum/event/prison_break/xenobiology
	eventDept = "Science"
	areaName = list("Ксенобиологическая Лаборатория")
...
/datum/event/prison_break/station
	eventDept = "Local"
	areaName = list("СБ - Тюрьма","Склад для Поставок","Ксенобиологическая Лаборатория","Инженерный Склад")
