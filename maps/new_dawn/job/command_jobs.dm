/datum/job/captain
	title = "Командир"
	supervisors = "Центральное Правительство Сола и Единый Кодекс Военной Юстиции Сола"
...
/datum/job/rd
	title = "Руководитель Исследований"
	supervisors = "Командир"
	economic_power = 20
	minimal_player_age = 14
	minimum_character_age = list(SPECIES_HUMAN = 35)
...
/datum/job/cmo
	title = "Главный Врач"
	supervisors = "Командир и Старпом"
	economic_power = 10
	minimal_player_age = 14
	minimum_character_age = list(SPECIES_HUMAN = 35)
...
/datum/job/chief_engineer
	...
	access = list(access_engine, access_engine_equip, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
			            ...
			            access_solgov_crew, access_robotics_engineering, access_seneng, access_hangar, access_robotics, access_torch_fax)
...
/datum/job/representative
	title = "Представитель СолПрава"
	department = "Support"
	department_flag = SPT
	total_positions = 1
	spawn_positions = 1
	supervisors = "Центральное Правительство Сола и Устав ЦПСС"
...
/datum/job/bridgeofficer
	title = "Вахтенный Офицер"
	department = "Support"
	department_flag = SPT
	total_positions = 3
	spawn_positions = 3
	supervisors = "Командир и остальные главы"
	selection_color = "#2f2f7f"
	minimal_player_age = 0
	economic_power = 7
