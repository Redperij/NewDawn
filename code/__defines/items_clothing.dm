...
#define SUIT_SENSOR_MODES list("Выключены" = SUIT_SENSOR_OFF, "Бинарные сенсоры" = SUIT_SENSOR_BINARY, "Жизненные показатели" = SUIT_SENSOR_VITAL, "Маяк слежения" = SUIT_SENSOR_TRACKING)
